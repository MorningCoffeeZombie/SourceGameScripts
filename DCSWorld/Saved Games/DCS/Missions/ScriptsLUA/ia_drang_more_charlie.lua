...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-1" )
	:InitLimit( 18, 24 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-2" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-3" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-4" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-5" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-6" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-7" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-8" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-9" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
...
Spawn_Troops = SPAWN:New( "NVA Entrenchment-Ten" )
	:InitLimit( 18, 24 )
	--:InitRandomizeZones( ZoneTable )
	:InitRandomizeTemplate( GroupTemplateTable )
	:InitRandomizeRoute( 2, 1, 2000 )
